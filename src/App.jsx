...
function Contact() {
  ...
  const socials = [
    ...
    { label: "Facebook", href: "https://www.facebook.com/people/Srajan-Kharvi/pfbid02gZrKaV9gbyt9rS636oz81M2YSfajPrKLctaDBGeLvaZCseZbFmZnSnWEptQpXuTrl/", icon: <FacebookIcon /> },
  ];
